...
import com.travlej.backend.exception.TokenException;
...
public class TokenProvider {
    ...
    public AccessTokenDTO generateMemberTokenDTO(MemberDTO foundMember) {
        ...
        Claims claims = Jwts
                .claims()
                .setSubject(String.valueOf(foundMember.getMemberCode()));
        ...
        return new AccessTokenDTO(BEARER_TYPE, foundMember.getMemberCode(), jwtToken,
